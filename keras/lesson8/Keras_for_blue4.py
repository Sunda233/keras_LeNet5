...
dense = Dense(units=2, activation='sigmoid', input_dim=2)  # 神经元数量，激活函数类型，输入特征的维度
...
model.compile(loss='mean_squared_error', optimizer=SGD(learning_rate=0.5), metrics=['accuracy'])
